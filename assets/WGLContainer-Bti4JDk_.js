import{b3 as q,R as ve,aD as Ee,aA as Se,eg as Oe,aO as Te,M as ft}from"./index-C1aGfQcb.js";import{w as Ae,a as ce,f as dt,g as _t,h as mt,i as vt,Z as F,_ as $e,$ as Pe}from"./definitions-C0Jy3zs7.js";import{e as pt,b as gt,h as Ze,f as L,n as re,s as le,r as ht}from"./LabelMetric-BbDPE4Hv.js";import{E as k}from"./BufferObject-C4qiEJeh.js";import{C as P,F as W,E as A,L as B,R as N,O as U,I as Q,N as xt,D as yt}from"./enums-Dk3osxpS.js";import{o as Z}from"./VertexArrayObject-CzGu5bI8.js";import{t as ne}from"./VertexElementDescriptor-BOD-G50G.js";import{e as St,a as ue}from"./ProgramTemplate-FAwkPdO7.js";import{r as Tt,n as pe,e as bt}from"./mat2df32-BR-p9z6z.js";import{r as Ke,i as ge,s as It}from"./mat3-Dg2BrR6m.js";import{e as ie,N as he,S as Ce,n as Et,o as Ot,E as ee}from"./MapView-DMINGQ-3.js";import{o as At,N as Pt}from"./vec32-CmwgPQMd.js";import{n as Ct}from"./vec3f32-nZdmKIgz.js";import{s as je,a as Dt}from"./Container-DukYN7bA.js";import{e as Rt}from"./TileKey-C3cOKqPf.js";import{e as Lt,m as Mt}from"./Texture-CLoEFKJJ.js";import{r as J,l as G,n as De}from"./StyleDefinition-BTt_i6C1.js";import{n as zt,t as Vt}from"./vec2f32-BbH2jxlN.js";import{e as Re}from"./config-MDUrh2eL.js";import{e as Nt}from"./earcut-Lltz9D9k.js";import{o as wt}from"./vec2-D9okOEat.js";import{n as Le}from"./vec2f64-CCfZVA9N.js";import{Q as Ft,K as Bt}from"./featureConversionUtils-C-Uqf9Q4.js";import{s as Me}from"./OptimizedGeometry-C9mSZhHi.js";let Ut=class extends je{constructor(e,t,n,i,o,a,r=o,l=a){super(),this.tileDebugInfoTexture=null,this.debugInfo={display:{length:0,minOrderedLength:0,minUnorderedLength:0,triangleCount:0},memory:{bytesUsed:0,bytesReserved:0}},this._destroyed=!1,this.key=new Rt(e),this.resolution=t,this.x=n,this.y=i,this.width=o,this.height=a,this.rangeX=r,this.rangeY=l}destroy(){this.tileDebugInfoTexture&&(this.tileDebugInfoTexture.dispose(),this.tileDebugInfoTexture=null),this._destroyed=!0}get debugSlot(){let e=this;for(;e.parent!==this._stage;){if(!e.parent)return 0;e=e.parent}return this._stage.children.indexOf(e)}setTransform(e){const t=this.resolution/(e.resolution*e.pixelRatio),n=this.transforms.tileMat3,[i,o]=e.toScreenNoRotation([0,0],[this.x,this.y]),a=this.width/this.rangeX*t,r=this.height/this.rangeY*t;Ke(n,a,0,0,0,r,0,i,o,1),ge(this.transforms.displayViewScreenMat3,e.displayViewMat3,n)}get destroyed(){return this._destroyed}};function qe(){return new Float32Array(4)}function Gt(c){const e=new Float32Array(4);return e[0]=c[0],e[1]=c[1],e[2]=c[2],e[3]=c[3],e}function H(c,e,t,n){const i=new Float32Array(4);return i[0]=c,i[1]=e,i[2]=t,i[3]=n,i}function Yt(c,e){return new Float32Array(c,e,4)}function Xe(){return qe()}function Qe(){return H(1,1,1,1)}function Je(){return H(1,0,0,0)}function et(){return H(0,1,0,0)}function tt(){return H(0,0,1,0)}function nt(){return H(0,0,0,1)}const kt=Xe(),Ht=Qe(),Wt=Je(),$t=et(),Zt=tt(),Kt=nt();Object.freeze(Object.defineProperty({__proto__:null,ONES:Ht,UNIT_W:Kt,UNIT_X:Wt,UNIT_Y:$t,UNIT_Z:Zt,ZEROS:kt,clone:Gt,create:qe,createView:Yt,fromValues:H,ones:Qe,unitW:nt,unitX:Je,unitY:et,unitZ:tt,zeros:Xe},Symbol.toStringTag,{value:"Module"}));const xe=new Map([["geometry",[new ne("a_pos",2,P.BYTE,0,2)]]]),oi=new Map([["geometry",[new ne("a_pos",2,P.BYTE,0,4),new ne("a_tex",2,P.BYTE,2,4)]]]),ai=new Map([["geometry",[new ne("a_pos",2,P.UNSIGNED_SHORT,0,4)]]]);let jt=class{constructor(e,t){this._rctx=e,this._attributes=[{name:"position",offset:0,type:P.SHORT,count:2}],this.layout={hash:pt(this._attributes),attributes:this._attributes,stride:4},this._vertexBuffer=k.createVertex(e,W.STATIC_DRAW,new Uint16Array(t)),this._vao=new Z(e,new Map([["a_position",0]]),new Map([["geometry",[new ne("a_position",2,P.SHORT,0,4)]]]),new Map([["geometry",this._vertexBuffer]])),this._count=t.length/2}bind(){this._rctx.bindVAO(this._vao)}unbind(){this._rctx.bindVAO(null)}dispose(){this._vao.dispose()}draw(){this._rctx.bindVAO(this._vao),this._rctx.drawArrays(A.TRIANGLE_STRIP,0,this._count)}},$=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const de={nearest:{defines:[],samplingMode:B.NEAREST,mips:!1},bilinear:{defines:[],samplingMode:B.LINEAR,mips:!1},bicubic:{defines:["bicubic"],samplingMode:B.LINEAR,mips:!1},trilinear:{defines:[],samplingMode:B.LINEAR_MIPMAP_LINEAR,mips:!0}},qt=(c,e,t)=>{if(t.samplingMode==="dynamic"){const{state:n}=c,i=e.resolution/e.pixelRatio/n.resolution,o=Math.round(c.pixelRatio)!==c.pixelRatio,a=i>1.05||i<.95;return n.rotation||a||o||e.isSourceScaled||e.rotation?de.bilinear:de.nearest}return de[t.samplingMode]};let Xt=class extends ${constructor(){super(...arguments),this._desc={vsPath:"raster/bitmap",fsPath:"raster/bitmap",attributes:new Map([["a_pos",0]])}}dispose(){this._quad&&this._quad.dispose()}prepareState({context:e}){e.setBlendingEnabled(!0),e.setColorMask(!0,!0,!0,!0),e.setStencilWriteMask(0),e.setStencilTestEnabled(!0)}draw(e,t){const{context:n,renderingOptions:i,painter:o,requestRender:a,allowDelayedRender:r}=e;if(!t.source||!t.isReady)return;const l=qt(e,t,i),s=o.materialManager.getProgram(this._desc,l.defines);if(r&&a!=null&&!s.compiled)return void a();e.timeline.begin(this.name),t.blendFunction==="additive"?n.setBlendFunctionSeparate(N.ONE,N.ONE,N.ONE,N.ONE):n.setBlendFunctionSeparate(N.ONE,N.ONE_MINUS_SRC_ALPHA,N.ONE,N.ONE_MINUS_SRC_ALPHA),n.setStencilFunction(U.EQUAL,t.stencilRef,255),this._quad||(this._quad=new jt(n,[0,0,1,0,0,1,1,1]));const{coordScale:u,computedOpacity:_,transforms:f}=t;t.setSamplingProfile(l),t.bind(e.context,Ae),n.useProgram(s),s.setUniformMatrix3fv("u_dvsMat3",f.displayViewScreenMat3),s.setUniform1i("u_texture",Ae),s.setUniform2fv("u_coordScale",u),s.setUniform1f("u_opacity",_),this._quad.draw(),e.timeline.end(this.name)}};const Qt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
